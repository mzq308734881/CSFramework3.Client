 ...
 *==========================================*/
    ...
    ///<summary>
    /// ORM模型, 数据表:tb_IC,由ClassGenerator自动生成
    /// </summary>
    [ORM_ObjectClassAttribute("tb_IC", "ICNO", true)]
    public sealed class tb_IC
    {
        public static string __TableName ="tb_IC";

        public static string __KeyName = "ICNO";
